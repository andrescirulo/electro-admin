var electroManagerApp = angular.module('electroManagerApp', [
  'ui.router','ngResource'
]);

electroManagerApp.config(function ($httpProvider){
...
electroManagerApp.factory('$context', function() {
	var context={};
	var map=new Array();
...
electroManagerApp.factory('$user', ['$state','User',function($state,User) {
